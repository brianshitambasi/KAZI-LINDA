...
// Update module.exports to include settings functions
// Note: If module.exports already exists, we need to replace it
// For now, we'll append to ensure they're added
