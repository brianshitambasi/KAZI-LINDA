...
const getFollowers = async (req, res) => {
  try {
    const connections = await Connection.find({ following: req.params.userId, status: 'accepted' })
...
const getFollowing = async (req, res) => {
  try {
    const connections = await Connection.find({ follower: req.params.userId, status: 'accepted' })
